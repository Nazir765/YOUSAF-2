...
clear= """)
print("""\033[1;97m  L E G E N D -- NAZIRO .X. KHAN. \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;94m➤\033[1;97m Author : Mr-NAZIR
...
def menu():
    ...
    print '\033[1;92m[2] Follow NAZIR KHAN'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-NAZIR➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
